...
struct ST {
    ...
    void init(int node, int b, int e)
    {
        ...
        init(left, b, mid);
        init(right, mid + 1, e);
        Tree[node] = Tree[left] xor Tree[right];
    }
    ...
    void update(int node, int b, int e, int i, int val)
    {
        ...
        if (b >= i and e <= i)
        {
            Tree[node] = Tree[node] xor val; //রিলেভেন্ট সেগমেন্ট
            return;
        }
...
void solve()
{
    ...
    while (q--)
    {
        ...
        else
        {
            ...
            int l,r;
            cin>>l>>r;
            int right = st.query(1,1,a,l,r);
            // int left = st.query(1,1,a,l-1,l-1);
            // int ans = right xor left;
            cout<<right<<nl;
            // cout<<left<<" "<<right<<nl;
        }
    }
