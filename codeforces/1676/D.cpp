...
ll go(int x, int y)
{
   ...
   // cout << sum << nl;
    ...
    while (p < a and q < b and q >= 0 and p >= 0) // niche left
    {
        sum += arr[p][q];
  ...
  //  cout << sum << nl;
    ...
    while (p >= 0 and q >= 0 and p < a and q < b) // upore right
    {
        sum += arr[p][q];
        p--;
        q++;
  ...
  //  cout << sum << nl;
    ...
    while (p >= 0 and q >= 0 and p < a and q < b) // upore left
    {
        sum += arr[p][q];
        p--;
        q--;
