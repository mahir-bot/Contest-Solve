...
void solve()
{
    ...
    int ans = 0;
    if (v[0].ff > v[1].ff and v[0].ff > v[2].ff)
    {
        ans =  v[0].ff - max(v[1].ff, v[2].ff);
    }
    if (v[0].ff < v[1].ff and v[0].ff < v[2].ff)
    {
        ans += min(v[1].ff, v[2].ff) - v[0].ff;
    }
    if (v[0].ss > v[1].ss and v[0].ss > v[2].ss)
    {
        ans +=  v[0].ss - max(v[1].ss, v[2].ss);
    }
    if (v[0].ss < v[1].ss and v[0].ss < v[2].ss)
    {
        ans += min(v[1].ss, v[2].ss) - v[0].ss;
    }
    cout << ans + 1 << nl;
