...
void solve()
{
    ...
    for (int i = 0; i<s.size(); i++)
    {
        if (s[i]=='b')
        {
            ...
            {
                // cout<<small.top().ff<<" "<<small.front().ss<<nl;
                small.pop();
            }
            continue;
        }
        if (s[i]=='B')
        {
            if (big.empty()==false)
            {
                // cout<<big.front().ff<<" "<<big.front().ss<<nl;
                big.pop();
            }
            continue;
        }
    ...
    while (big.empty()==false or small.empty()==false)
    {

        if (big.empty())
        {
            // cout<<small.front().ff<<" "<<small.front().ss<<nl;
            ans+=small.top().ff;
            small.pop();
            continue;
        }
